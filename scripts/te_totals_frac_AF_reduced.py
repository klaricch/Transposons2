...
OUT=open("kin_frac_matrix_AF_reduced.txt", 'w')
OUTC=open("kin_C_matrix_AF_reduced.txt", 'w')
OUTN=open("kin_C_matrix_NAs_AF_reduced.txt", 'w') #NA
...
with open(infile, 'r') as IN:
	...
	for i in sorted(all_families.keys()):
		...
		OUT.write("\t"+nameA)
		OUTC.write("\t"+nameA+"_C")
		OUTN.write("\t"+nameR+"_NA")
		OUTN.write("\t"+nameA+"_NA")
